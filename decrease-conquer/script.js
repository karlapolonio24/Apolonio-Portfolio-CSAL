    ...
    for (let i = 1; i < rows.length; i++) {
        ...
        while (j >= 0) {
            ...
            if (!isNaN(currentValue) && !isNaN(comparisonValue)) {
                ...
                condition = ascending ? currentValue.toString().toLowerCase() < comparisonValue.toString().toLowerCase() : currentValue.toString().toLowerCase() > comparisonValue.toString().toLowerCase();
            }
...
excel_btn.onclick = () => {
    ...
    var ws = XLSX.utils.table_to_sheet(customers_table);
